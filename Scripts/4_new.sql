...
REVOKE EXECUTE ON tryndamere.agregar_batalla FROM TRYNDAMERE_insert;
REVOKE EXECUTE ON agregar_carta FROM TRYNDAMERE_insert;
REVOKE EXECUTE ON agregar_division FROM TRYNDAMERE_insert;
REVOKE EXECUTE ON agregar_invocador FROM TRYNDAMERE_insert;
REVOKE EXECUTE ON agregar_mazo FROM TRYNDAMERE_insert;
REVOKE EXECUTE ON agregar_region FROM TRYNDAMERE_insert;
REVOKE EXECUTE ON agregar_rioter FROM TRYNDAMERE_insert;
REVOKE EXECUTE ON agregar_servidor FROM TRYNDAMERE_insert;
REVOKE EXECUTE ON agregar_usuario FROM TRYNDAMERE_insert;

GRANT EXECUTE ON tryndamere.agregar_batalla TO TRYNDAMERE_insert;
GRANT EXECUTE ON agregar_carta TO TRYNDAMERE_insert;
GRANT EXECUTE ON agregar_division TO TRYNDAMERE_insert;
GRANT EXECUTE ON agregar_invocador TO TRYNDAMERE_insert;
GRANT EXECUTE ON agregar_mazo TO TRYNDAMERE_insert;
GRANT EXECUTE ON agregar_region TO TRYNDAMERE_insert;
GRANT EXECUTE ON agregar_rioter TO TRYNDAMERE_insert;
GRANT EXECUTE ON agregar_servidor TO TRYNDAMERE_insert;
GRANT EXECUTE ON agregar_usuario TO TRYNDAMERE_insert;
